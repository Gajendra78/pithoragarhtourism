!(function (a, b) {
  ...
  (c.prototype = {
    ...
    (b.fn.filterizr = function () {
      ...
      if (
        (a._fltr ||
          (a._fltr = b.fn.filterizr.prototype.init(
            a,
            "object" == typeof c[0] ? c[0] : void 0
          )),
        "string" == typeof c[0])
      ) {
    ...
    (b.fn.filterizr.prototype = {
      init: function (a, c) {
        ...
        return (
          ...
          1 === arguments.length &&
            ...
            (c = arguments[0]),
          c && d.setOptions(c),
          d.css({ padding: 0, position: "relative" }),
          (d._lastCategory = 0),
          (d._isAnimating = !1),
          (d._isShuffling = !1),
          (d._isSorting = !1),
          ...
          (d._uID = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(
            /[xy]/g,
            function (a) {
      ...
      toggleFilter: function (a) {
        ...
        b.trigger("filteringStart"),
          a &&
            (b._toggledCategories[a]
              ? delete b._toggledCategories[a]
              : (b._toggledCategories[a] = !0)),
          b._multifilterModeOn()
            ? ((c = b._makeMultifilterArray()),
              b._handleFiltering(c),
              b._isSearchActivated() && b.search(b._typedText))
            : (b.filter("all"),
              b._isSearchActivated() && b.search(b._typedText));
      ...
      search: function (a) {
        var b = this,
          c = b._multifilterModeOn()
            ? b._makeMultifilterArray()
      ...
      shuffle: function () {
        ...
        var b = a._multifilterModeOn()
          ? a._makeMultifilterArray()
          : a._getCollectionByFilter(a.options.filter);
      ...
      sort: function (a, b) {
        ...
        var f = c._multifilterModeOn()
          ? c._makeMultifilterArray()
          : c._getCollectionByFilter(c.options.filter);
      ...
      setOptions: function (a) {
        ...
        if (
          b._mainArray &&
          (a.animationDuration || a.delay || a.easing || a.delayMode)
        )
          for (c = 0; c < b._mainArray.length; c++)
            b._mainArray[c].css(
              "transition",
              "all " +
                b.options.animationDuration +
                "s " +
                b.options.easing +
                " " +
                b._mainArray[c]._calcDelay() +
                "ms"
            );
        a.callbacks &&
          (a.callbacks.onFilteringStart ||
            (b.options.callbacks.onFilteringStart = function () {}),
          a.callbacks.onFilteringEnd ||
            (b.options.callbacks.onFilteringEnd = function () {}),
          a.callbacks.onShufflingStart ||
            (b.options.callbacks.onShufflingStart = function () {}),
          a.callbacks.onShufflingEnd ||
            (b.options.callbacks.onShufflingEnd = function () {}),
          a.callbacks.onSortingStart ||
            (b.options.callbacks.onSortingStart = function () {}),
          a.callbacks.onSortingEnd ||
            (b.options.callbacks.onSortingEnd = function () {})),
          b.options.filterInCss.transform ||
            (b.options.filterInCss.transform = "translate3d(0,0,0)"),
          b.options.filterOutCss.transform ||
            (b.options.filterOutCss.transform = "translate3d(0,0,0)");
      },
      ...
      _setupControls: function () {
        ...
        b("*[data-filter]").click(function () {
          ...
          b("*[data-multifilter]").click(function () {
            ...
            "all" === c
              ? ((a._toggledCategories = {}), a.filter("all"))
              : a.toggleFilter(c);
          }),
      ...
      _calcItemPositions: function () {
        ...
        if ("packed" === a.options.layout) {
          ...
          for (o.fit(a._activeArray), l = 0; l < d.length; l++)
            n.push({ left: d[l].fit.x, top: d[l].fit.y });
          e = o.root.h;
        }
        if ("horizontal" === a.options.layout)
          for (g = 1, l = 1; l <= d.length; l++)
            (h = d[l - 1].outerWidth()),
              (i = d[l - 1].outerHeight()),
              n.push({ left: j, top: k }),
              (j += h),
          ...
          for (l = 1; l <= d.length; l++)
            (i = d[l - 1].outerHeight()), n.push({ left: j, top: k }), (k += i);
          e = k;
      ...
      _handleFiltering: function (a) {
        for (
          var b = this, c = b._getArrayOfUniqueItems(b._activeArray, a), d = 0;
          d < c.length;
          d++
        )
          c[d]._filterOut();
      ...
      _getArrayOfUniqueItems: function (a, b) {
        ...
        for (e = a.length, f = 0; f < e; f++)
          (g = a[f]), g.domIndex in d || c.push(g);
        return c;
      },
  ...
  var d = {
    ...
    _calcDelay: function () {
      var a = this,
        b = 0;
      return (
        "progressive" === a._parent.options.delayMode
          ? (b = a._parent.options.delay * a.domIndex)
          : a.domIndex % 2 == 0 && (b = a._parent.options.delay),
        b
      );
    },
    _getCategory: function () {
      ...
      if ("string" == typeof b) {
        ...
        for (var c = 0; c < b.length; c++) {
          ...
          parseInt(b[c]) > a._parent._lastCategory &&
            (a._parent._lastCategory = parseInt(b[c]));
        }
    ...
    _onTransitionEnd: function () {
      var a = this;
      a._filteringOut
        ? (b(a).addClass("filteredOut"),
          (a._isFilteredOut = !0),
          (a._filteringOut = !1))
        : a._filteringIn && ((a._isFilteredOut = !1), (a._filteringIn = !1)),
        a._parent._isAnimating &&
          (a._parent._isShuffling
            ? a._parent.trigger("shufflingEnd")
            : a._parent._isSorting
            ? a._parent.trigger("sortingEnd")
            : a._parent.trigger("filteringEnd"),
    ...
    _filterOut: function () {
      ...
      (b.transform +=
        " translate3d(" + a._lastPos.left + "px," + a._lastPos.top + "px, 0)"),
        a.css(b),
